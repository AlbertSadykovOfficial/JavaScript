/*
		...
		Событийый цикл
				...
				Разбиение сложных-длительных задач
						...
						Вспомним: Браузер однопоточный, он выполняет задачи в 1 поток по мере их поступления.

						Если мы дадим такую задачу Движку браузера на обработку, то он встанет на ее выполнении,
