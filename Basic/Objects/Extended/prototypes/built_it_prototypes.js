/*
		...
		Встроенные прототипы:
				...
				Обо всех встроенных объектах (функциях, массивах, дате и др.)
...
[[Prototype]]							|										|										 |
				...
				Изменение встроенных прототипов
						...
						Встроенные прототипы можно изменить, но делать этого не рекомендуется, потомучто такое изменение
						глобально.
...
*/
		...
		// Заимствование метода у прототипа
			...
			let obj = {
				  0: "Hello",
				  1: "world!",
				  length: 2,  // Join требует длину массива, поэтому он тут нужен
			};
